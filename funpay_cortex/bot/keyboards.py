"""Inline-клавиатуры для Telegram-бота (все функции доступны каждому пользователю)."""

from telegram import InlineKeyboardButton, InlineKeyboardMarkup


def main_menu_kb() -> InlineKeyboardMarkup:
    """Главное меню — все кнопки доступны всем."""
...
def settings_kb(config) -> InlineKeyboardMarkup:
    """Клавиатура настроек — все переключатели доступны всем."""
